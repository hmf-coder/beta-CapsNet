...
class ReconstructionNet(nn.Module):
    def __init__(self, n_dim, n_classes=10):
        ...
        self.conv6 = nn.ConvTranspose2d(32, 3, 4, 2, 1)
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder('../data/celeba/img_align_celeba', 
                       transform=transforms.Compose([
                           transforms.Pad(2), transforms.CenterCrop((128,128)), 
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        torch.save(model.state_dict(), './trained_model/CelebA_centercrop_{}epoch_dim{}_kl{}_rec{:.4f}_kl{:.8f}.pth'.format(epoch, dim, klloss_alpha,
